...
import UserList from './Backend/UserList.js';
import QuestionList from './Backend/QuestionList.js'
import Addmin from './Backend/Addmin.js';

function App() {
  return (
    <Router basename={'/SmartClinic'}>
      <Routes>
